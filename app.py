...
KANITA_MEMORY = {
    ...
    "help_info": {
        ...
        "cabang": [
            ...
            {"name": "HOS COKROAMINOTO", "lokasi": "Jogja"},
            {"name": "KEBON JUKUT", "lokasi": "Bandung"},
            {"name": "SOEKARNO", "lokasi": "Surabaya"},
            {"name": "SUDIRMAN", "lokasi": "Semarang"},
        ],
        "additional": ["Menampilkan tentang data atau sejarah"],
    },
    "greetings": [
